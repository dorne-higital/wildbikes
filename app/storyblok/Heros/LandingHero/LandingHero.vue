<template>
	...
	>
		<div class="media-wrapper">
			...
			<img
				v-else-if="blok.backgroundImage?.filename"
				class="media-image"
		...
		>
			<div class="hero-inner">
				...
				>
					...
					>
						{{ blok.primaryLinkText ? blok.primaryLinkText : blok.primaryCta.cached_url }}
					</NuxtLink>
					...
					>
						{{ blok.secondaryLinkText ? blok.secondaryLinkText : blok.secondaryCta.cached_url }}
					</NuxtLink>
				</div>
			</div>
		</div>
